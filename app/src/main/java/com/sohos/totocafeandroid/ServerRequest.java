...
public class ServerRequest {
    ...
    public class StoreUserDataAsyncTask extends AsyncTask<Void,Void, Void>{
        ...
        protected Void doInBackground(Void... params) {
            ...
            HttpPost post = new HttpPost(SERVER_ADDRESS + "Register.php");//Burası değişecek
            try{
    ...
    public class fetchUserDataAsyncTask extends AsyncTask<Void,Void, User>{
        ...
        protected User doInBackground(Void... params) {
            ...
            HttpClient client = new DefaultHttpClient(httpRequestParams);
            HttpPost post = new HttpPost(SERVER_ADDRESS + "fetchUserData.php");//Burası değişecek
            ...
            try{
                ...
                if(jObject.length() == 0){
                    ...
                    returnedUser = new User(name,surname, user.username, user.password, age);
                }
            }
            catch (Exception e){
                e.printStackTrace();
